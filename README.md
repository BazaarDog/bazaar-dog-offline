...
[![Greenkeeper badge](https://badges.greenkeeper.io/BazaarDog/bazaar-dog-offline.svg)](https://greenkeeper.io/)
[![Travis](https://img.shields.io/travis/BazaarDog/bazaar-dog-offline.svg)](https://travis-ci.org/BazaarDog/bazaar-dog-offline)
...
```bash
git clone https://github.com/BazaarDog/bazaar-dog-offline.git YOURFOLDERNAME
cd YOURFOLDERNAME
...
This project was froked form @alexjoverm's typescript starter project, Below are those that contributed to this awesome starter
